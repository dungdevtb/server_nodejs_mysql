...
svRouter.get("/api/user/get-list-user", checkToken, Response(UserController.getListUser));
svRouter.post("/api/user/update_user", checkToken, Response(UserController.updateUser));
